          ...
          <CardContent>
            <form className="space-y-3" onSubmit={handleSubmit}>
              ...
              <p className="text-xs text-neutral-500">
                Submitting shares your selections with us. No payment required
                yet.
              </p>
            </form>
          </CardContent>
...
function Tutorials() {
  const vids = [
    {
      id: "vid1",
      title: "Beginner: 30-min Faux Wreath",
      dur: "30:12",
      thumb:
    ...
    {
      id: "vid2",
      title: "Dried Florals Centerpiece",
      dur: "18:47",
      thumb:
        "https://images.unsplash.com/photo-1501447108233-4a8d6d83dfdf?q=80&w=1200&auto=format&fit=crop",
    },
    {
      id: "vid3",
      title: "Memorial Arrangement Basics",
      dur: "22:03",
      thumb:
        "https://images.unsplash.com/photo-1470058869958-2a77ade41c02?q=80&w=1200&auto=format&fit=crop",
    },
  ];
  ...
  return (
    <section id="tutorials" className="bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 py-16">
        <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
          Free tutorials & mildly chaotic maker resources
        </h2>
        <p className="mt-2 max-w-2xl text-neutral-600">
          Learn at your own pace. All videos include captions and seated-position
          variations for low-energy days.
        </p>
        ...
        <div className="mt-10 rounded-2xl border bg-white p-6">
          ...
          <p className="mt-1 text-sm text-neutral-600">
            Monthly tips, tool lists, and printable guides—with occasional
            terrible puns. Unsubscribe anytime.
          </p>
  ...
  return (
    <section id="about" className="mx-auto max-w-7xl px-4 py-16">
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
            Our story & shenanigans
          </h2>
          <p className="mt-3 text-neutral-700">
            We craft decor that feels like home—and sometimes makes you
            snort-laugh. Founded by a professional floral designer named
            Melissa, our studio runs on joy, gentle pacing, and a strategically
            placed snack drawer. Every purchase supports fair pay, flexible
            workflows, and captioned tutorials for the community.
          </p>
          <ul className="mt-4 space-y-2 text-neutral-700">
            <li className="flex items-start gap-2">
              <Check className="mt-0.5 h-5 w-5 text-emerald-600" /> Seated-friendly
              processes, adjustable work heights, and zero ladder drama
            </li>
            <li className="flex items-start gap-2">
              <Check className="mt-0.5 h-5 w-5 text-emerald-600" /> Lightweight
              tools to reduce strain, fatigue, and grumpy elbows
            </li>
            <li className="flex items-start gap-2">
              <Check className="mt-0.5 h-5 w-5 text-emerald-600" /> Clear pricing,
              custom options, and fast confirmations (slightly slower during
              cookie breaks)
            </li>
          </ul>
        </div>
...
function FAQ() {
  const faqs = [
    {
      q: "How do you price customs?",
      a: "By category, size, and materials. The builder shows a live estimate; we confirm by email before payment—no surprises, just sparkles.",
    },
    {
      q: "Do you ship?",
      a: "Yep! Wreaths and dried pieces ship across the U.S. Fresh items are local delivery or pickup because we do not trust the postal system with moist foliage.",
    },
    {
      q: "Do you offer memorial/gravesite pieces?",
      a: "We create tasteful memorial wreaths and saddle arrangements. Share cemetery regulations in the notes, and we’ll tailor the design—respectful first, fancy second.",
    },
    {
      q: "Are tutorials beginner-friendly?",
      a: "Absolutely. Captions, tool lists, and seated alternatives included. If you can wield scissors and a good pun, you’re in.",
    },
  ];
  return (
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <div>
          ...
          <p className="mt-2 text-neutral-700">
            Have a question or a big idea? We’re here to help.
          </p>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1 text-sm text-neutral-700">
            <li>
              <a href="#shop">Wreaths</a>
            </li>
            <li>
              <a href="#shop">Centerpieces</a>
            </li>
            <li>
              <a href="#shop">Memorial</a>
            </li>
          </ul>
        </div>
        <div>
